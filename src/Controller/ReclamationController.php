...
class ReclamationController extends AbstractController
{
     ...
     */
    public function afficheR(Request $request,PaginatorInterface $paginator): Response
    {
     ...
     */
    public function ajoutR(Request $request,ValidatorInterface $validator,TranslatorInterface $translator): Response
    {
        ...
        if ($form->isSubmitted()&& $form->isValid()) {
            ...
            $this->addFlash('message','Reclamation Envoyé !');
